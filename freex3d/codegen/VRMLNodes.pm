...
#	Chapter 12:		Shape Component
	...
	"AudioBufferSourceNode" => new VRML::NodeType("AudioBufferSourceNode", [
		...
		loopStart => ["SFFloat", 0, "inputOutput", "(SPEC_X3D40)","UNCA_NONE"],#ff
		loopEnd => ["SFFloat", 0, "inputOutput", "(SPEC_X3D40)","UNCA_NONE"],#ff
	],"X3DAudioNode"),
	...
	"DynamicsCompressorNode" => new VRML::NodeType("DynamicsCompressorNode", [
		...
		reduction => ["SFFloat", 0, "inputOutput", "(SPEC_X3D40)","UNCA_NONE"],#ff
		attack => ["SFFloat", .25, "inputOutput", "(SPEC_X3D40)","UNCA_NONE"],#ff
		release => ["SFInt32", -24, "inputOutput", "(SPEC_X3D40)","UNCA_NONE"],#ff
	],"X3DAudioNode"),
	...
	"AnalyserNode" => new VRML::NodeType("AnalyserNode", [
		...
		maxDecibels => ["SFFloat", -10, "inputOutput", "(SPEC_X3D40)","UNCA_NONE"],#ff
	...
	"PannerNode" => new VRML::NodeType("PannerNode", [
		...
		coneInnerAngle => ["SFFloat", 360, "inputOutput", "(SPEC_X3D40)","UNCA_NONE"],#ff
		coneOuterAngle => ["SFFloat", 360, "inputOutput", "(SPEC_X3D40)","UNCA_NONE"],#ff
		coneGain => ["SFFloat", 0, "inputOutput", "(SPEC_X3D40)","UNCA_NONE"],#ff
		...
		panningModel => ["SFString", "HRTF", "inputOutput", "(SPEC_X3D40)","UNCA_NONE"],#ff
		refDistance => ["SFFloat", 1, "inputOutput", "(SPEC_X3D40)","UNCA_NONE"],#ff
...
#
	...
	# Chapter 43:		ProjectiveTextureMapping Component
	...
	"TextureProjectorParallel" => new VRML::NodeType("TextureProjectorParallel", [
		#same field order as TextureProjector, excpet fieldOfView last, which is different
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33 | SPEC_X3D40)","UNCA_NONE"],#ff
		description => ["SFString", "", "inputOutput", "(SPEC_VRML | SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33 | SPEC_X3D40)","UNCA_NONE"],#ff
		location=> ["SFVec3f", [0, 0, 1], "inputOutput", "(SPEC_VRML | SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33 | SPEC_X3D40)","UNCA_NONE"],#ff
		direction => ["SFVec3f", [0, 0, 1], "inputOutput", "(SPEC_VRML | SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33 | SPEC_X3D40)","UNCA_NONE"],#ff
		...
		_upVec => ["SFVec4f",[0,0,0,0],"initializeOnly",0,0],#ff
		upVector => ["SFVec3f", [0, 1, 0], "inputOutput", "(SPEC_VRML | SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33 | SPEC_X3D40)","UNCA_NONE"],#ff
		fieldOfView => ["MFFloat", [-1, -1, 1, 1], "inputOutput", "(SPEC_VRML | SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33 | SPEC_X3D40)","UNCA_NONE"],#ff

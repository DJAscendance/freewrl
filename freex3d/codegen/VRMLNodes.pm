...
our %Nodes = (
	...
	"Switch" => new VRML::NodeType("Switch", [
		...
		__sibAffectors => ["MFNode", [], "inputOutput", "(SPEC_VRML | SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		choice => ["MFNode", [], "inputOutput", "(SPEC_VRML | SPEC_X3D30)"],		# VRML nodes....
		children => ["MFNode", [], "inputOutput", "(SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],		# X3D nodes....
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
...
#	Chapter 12:		Shape Component
	...
	"MovieTexture" => new VRML::NodeType ("MovieTexture", [
		...
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		pauseTime => ["SFTime",0,"inputOutput", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		pitch => ["SFFloat", 1.0, "inputOutput", "(SPEC_X3D33)"],
		resumeTime => ["SFTime",0,"inputOutput", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		startTime => ["SFTime", 0, "inputOutput", "(SPEC_VRML | SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		stopTime => ["SFTime", 0, "inputOutput", "(SPEC_VRML | SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		url => ["MFString", [""], "inputOutput", "(SPEC_VRML | SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
	...
	"GeneratedCubeMapTexture" => new VRML::NodeType("GeneratedCubeMapTexture", [
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		textureProperties => ["SFNode", "NULL", "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		__textureTableIndex => ["SFInt32", 0, "initializeOnly", 0],
		_parentResource =>["FreeWRLPTR",0,"initializeOnly", 0],
...
#
	...
	"GeoCoordinate" => new VRML::NodeType("GeoCoordinate", [
		...
		geoOrigin => ["SFNode", "NULL", "initializeOnly", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 )"],
	...
	"GeoPositionInterpolator" => new VRML::NodeType("GeoPositionInterpolator", [
		...
		geoOrigin => ["SFNode", "NULL", "initializeOnly", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 )"],
		geoSystem => ["MFString",["GD","WE"],"initializeOnly", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 )"],
		__geoSystem => ["MFInt32",[],"initializeOnly", 0],
	...
	"GeoProximitySensor" => new VRML::NodeType("ProximitySensor", [
		...
		geoCenter => ["SFVec3d", [0, 0, 0], "inputOutput", "(SPEC_X3D32)"],
		center => ["SFVec3d", [0, 0, 0], "inputOutput", "(SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D33)"],
		...
		geoOrigin => ["SFNode", "NULL", "initializeOnly", "(SPEC_X3D32)"],
	...
	"GeoTransform" => new VRML::NodeType ("GeoTransform", [
		...
		__sibAffectors => ["MFNode", [], "inputOutput", 0],
	...
	"GeoViewpoint" => new VRML::NodeType("GeoViewpoint", [
		...
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		orientation => ["SFRotation", [0, 0, 1, 0], "inputOutput", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"], # see note top of file, AND spec changed to in/out in 3.3
		position => ["SFVec3d",[0, 0, 100000], "inputOutput", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"], # ditto
		centerOfRotation => ["SFVec3d",[0, 0, 0], "inputOutput", "( SPEC_X3D33)"],
		_layerId => ["SFInt32",0,"initializeOnly",0],
		_donethispass => ["SFInt32",0,"initializeOnly",0],
		set_orientation => ["SFRotation", ["IO_FLOAT", "IO_FLOAT", "IO_FLOAT", "IO_FLOAT"], "inputOnly", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 )"],
		set_position => ["SFVec3d", ["IO_FLOAT", "IO_FLOAT", "IO_FLOAT"], "inputOnly", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 )"],
		# GeoViewpoint fields
		headlight => ["SFBool", "TRUE", "inputOutput", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 )"],
		navType => ["MFString", ["EXAMINE","ANY"],"inputOutput", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 )"],
		geoOrigin => ["SFNode", "NULL", "initializeOnly", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 )"],
		geoSystem => ["MFString",["GD","WE"],"initializeOnly", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		speedFactor => ["SFFloat",1.0,"initializeOnly", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		retainUserOffsets => ["SFBool", "FALSE", "inputOnly", "(SPEC_X3D33)"],
	...
	"DISEntityTypeMapping" => new VRML::NodeType("DISEntityTypeMapping", [
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		url => ["MFString", [], "inputOutput", "(SPEC_VRML | SPEC_X3D32 | SPEC_X3D33)"],
	...
	"EspduTransform" => new VRML::NodeType("EspduTransform", [
		...
		__sibAffectors => ["MFNode", [], "inputOutput", "(SPEC_VRML | SPEC_X3D32 | SPEC_X3D33)"],
		...
		geoCoords => ["SFVec3d", [0,0,0], "inputOutput", "(SPEC_X3D33)"],
		geoSystem => ["MFString", ["GC","WE"], "initializeOnly", "(SPEC_X3D33)"],
	...
	"ImageTexture3D" => new VRML::NodeType("ImageTexture3D", [
		...
		textureProperties => ["SFNode", 0, "initializeOnly", "(SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		__textureTableIndex => ["SFInt32", 0, "initializeOnly", 0],
		_parentResource =>["FreeWRLPTR",0,"initializeOnly", 0],
	...
	"ComposedTexture3D" => new VRML::NodeType("ComposedTexture3D", [
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		texture=>["MFNode",undef,"inputOutput", "(SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		textureProperties => ["SFNode", 0, "initializeOnly", "(SPEC_X3D33)"],
		repeatS => ["SFBool", "FALSE", "initializeOnly", "(SPEC_VRML | SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		repeatT => ["SFBool", "FALSE", "initializeOnly", "(SPEC_VRML | SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		repeatR => ["SFBool", "FALSE", "initializeOnly", "(SPEC_VRML | SPEC_X3D30 | SPEC_X3D31 | SPEC_X3D32 | SPEC_X3D33)"],
		__textureTableIndex => ["SFInt32", 0, "initializeOnly", 0],
	...
	"Viewport" => new VRML::NodeType("Viewport", [
		addChildren => ["MFNode", undef, "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		removeChildren => ["MFNode", undef, "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		__sibAffectors => ["MFNode", [], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		children => ["MFNode", [], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		clipBoundary => ["MFFloat",[],"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		bboxCenter => ["SFVec3f", [0,0,0], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		bboxSize => ["SFVec3f", [-1,-1,-1], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
	], "X3DViewportNode"),
	...
	"Layer" => new VRML::NodeType("Layer", [
		...
		children => ["MFNode", [], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		isPickable => ["SFBool", "TRUE", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		viewport => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
	], "X3DLayerNode"),

	"LayerSet" => new VRML::NodeType("LayerSet", [
		activeLayer => ["SFInt32", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		layers => ["MFNode", [], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		order => ["MFInt32",[0],"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
	], "X3DLayerSetNode"),
	...
	"Layout" => new VRML::NodeType("Layout", [
		align => ["MFString", ["CENTER","CENTER"], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		offset => ["MFFloat",[0,0],"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		offsetUnits => ["MFString", ["WORLD","WORLD"], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		scaleMode => ["MFString", ["NONE","NONE"], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		size => ["MFFloat",[1,1],"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		sizeUnits => ["MFString", ["WORLD","WORLD"], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
	...
	"LayoutGroup" => new VRML::NodeType("LayoutGroup", [
		...
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		bboxCenter => ["SFVec3f", [0,0,0], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		bboxSize => ["SFVec3f", [0,0,0], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		layout => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		viewport => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
	], "X3DGroupingNode"),
	...
	"ScreenFontStyle" => new VRML::NodeType("ScreenFontStyle", [
                metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		family => ["MFString", ["SERIF"], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		horizontal => ["SFBool", "TRUE", "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		justify => ["MFString", ["BEGIN"], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		language => ["SFString", "", "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		leftToRight => ["SFBool", "TRUE", "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		pointSize => ["SFFloat", 12.0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"], # see note top of file
		spacing => ["SFFloat", 1.0, "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		style => ["SFString", "PLAIN", "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		topToBottom => ["SFBool", "TRUE", "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
	],"X3DFontStyleNode"),
	...
	"BallJoint" => new VRML::NodeType("BallJoint", [
		anchorPoint => ["SFVec3f", [0,0,0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		body1 => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		body2 => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		forceOutput => ["MFString", ["NONE"], "inputOutput", "(SPEC_VRML | SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		body1AnchorPoint => ["SFVec3f",[0,0,0],"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		body2AnchorPoint => ["SFVec3f",[0,0,0],"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_joint => ["FreeWRLPTR", 0, "initializeOnly", 0],
		_forceout => ["SFInt32", 0, "initializeOnly", 0],
		__old_anchorPoint => ["SFVec3f", [0,0,0], "inputOutput", 0],
		__old_body1 => ["SFNode", "NULL", "inputOutput", 0],
		__old_body2 => ["SFNode", "NULL", "inputOutput", 0],
	], "X3DRigidJointNode"),

	"CollidableOffset" => new VRML::NodeType("CollidableOffset", [
		enabled => ["SFBool", "TRUE", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		rotation => ["SFRotation", [0, 0, 1, 0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		translation => ["SFVec3f", [0, 0, 0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		bboxCenter => ["SFVec3f", [0,0,0], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		bboxSize => ["SFVec3f", [-1,-1,-1], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		__do_trans => ["SFInt32", "FALSE", "initializeOnly", 0],
		__do_rotation => ["SFInt32", "FALSE", "initializeOnly", 0],
		collidable => ["SFNode", "NULL", "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
	...
	"CollidableShape" => new VRML::NodeType("CollidableShape", [
		...
		__do_trans => ["SFInt32", "FALSE", "initializeOnly", 0],
		__do_rotation => ["SFInt32", "FALSE", "initializeOnly", 0],
		shape => ["SFNode", "NULL", "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_geom => ["FreeWRLPTR", 0, "initializeOnly", 0],
		_initialRotation => ["SFRotation", [0, 0, 1, 0], "initializeOnly", 0], 
		_initialTranslation => ["SFVec3f", [0, 0, 0], "initializeOnly", 0],
		_initialized => ["SFBool",0,"initializeOnly",0],
	...
	"CollisionCollection" => new VRML::NodeType("CollisionCollection", [
		appliedParameters => ["MFString", ["BOUNCE"], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		bounce => ["SFFloat", 0.0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"], # see note top of file
		collidables => ["MFNode", [], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		enabled => ["SFBool", "TRUE", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		frictionCoefficients => ["SFVec2f", [0, 0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
                metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		minBounceSpeed => ["SFFloat", 0.1, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"], # see note top of file
		slipFactors => ["SFVec2f", [0, 0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		softnessConstantForceMix => ["SFFloat", 0.0001, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"], # see note top of file
		softnessErrorCorrection => ["SFFloat", 0.8, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"], # see note top of file
		surfaceSpeed => ["SFVec2f", [0, 0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
	...
	"CollisionSensor" => new VRML::NodeType("CollsionSensor", [
		collider => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		enabled => ["SFBool", "TRUE", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		intersections => ["MFNode", [], "outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		contacts => ["MFNode", [], "outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		isActive => ["SFBool", "TRUE", "outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
	], "X3DSensorNode"),
	...
	"CollisionSpace" => new VRML::NodeType("CollisionSpace", [
		...
		enabled => ["SFBool", "TRUE", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		useGeometry => ["SFBool", "FALSE", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		bboxCenter => ["SFVec3f", [0,0,0], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		bboxSize => ["SFVec3f", [-1,-1,-1], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
	...
	"Contact" => new VRML::NodeType("Contact", [
		...
		body1 => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		body2 => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		bounce => ["SFFloat", 0.0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		contactNormal => ["SFVec3f", [0,1,0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		depth => ["SFFloat", 0.0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		frictionCoefficients => ["SFVec2f", [0, 0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		frictionDirection => ["SFVec3f", [0,1,0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		geometry1 => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		geometry2 => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		minBounceSpeed => ["SFFloat", 0.0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		position => ["SFVec3f", [0, 0, 0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		slipCoefficients => ["SFVec2f", [0, 0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		softnessConstantForceMix => ["SFFloat", 0.0001, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		softnessErrorCorrection => ["SFFloat", 0.8, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		surfaceSpeed => ["SFVec2f", [0, 0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
	...
	"DoubleAxisHingeJoint" => new VRML::NodeType("DoubleAxisHingeJoint", [
		anchorPoint => ["SFVec3f", [0,0,0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		axis1 => ["SFVec3f", [0,0,0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		axis2 => ["SFVec3f", [0,0,0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		body1 => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		body2 => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		desiredAngularVelocity1 => ["SFFloat", 0.0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		desiredAngularVelocity2 => ["SFFloat", 0.0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		forceOutput => ["MFString", ["NONE"], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		maxAngle1 => ["SFFloat", "PIF+", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		maxTorque1 => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		maxTorque2 => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		minAngle1 => ["SFFloat", "-PIF+", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		stopBounce1 => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		stopConstantForceMix1 => ["SFFloat", .001, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		stopErrorCorrection1 => ["SFFloat", .8, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		suspensionErrorCorrection => ["SFFloat", .8, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		suspensionForce => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		body1AnchorPoint => ["SFVec3f",[0,0,0],"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		body1Axis => ["SFVec3f",[0,0,0],"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		body2AnchorPoint => ["SFVec3f",[0,0,0],"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		body2Axis => ["SFVec3f",[0,0,0],"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		hinge1Angle=>["SFFloat",0.0,"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		hinge1AngleRate=>["SFFloat",0.0,"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		hinge2Angle=>["SFFloat",0.0,"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		hinge2AngleRate=>["SFFloat",0.0,"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_joint => ["FreeWRLPTR", 0, "initializeOnly", 0],
		_forceout => ["SFInt32", 0, "initializeOnly", 0],
		__old_anchorPoint => ["SFVec3f", [0,0,0], "inputOutput", 0],
		__old_axis1 => ["SFVec3f", [0,0,0], "inputOutput", 0],
		__old_axis2 => ["SFVec3f", [0,0,0], "inputOutput", 0],
		__old_body1 => ["SFNode", "NULL", "inputOutput", 0],
		__old_body2 => ["SFNode", "NULL", "inputOutput", 0],
		_motor1 => ["FreeWRLPTR", 0, "initializeOnly", 0],
		_motor2 => ["FreeWRLPTR", 0, "initializeOnly", 0],
		axis1Angle => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
	], "X3DRigidJointNode"),

	"MotorJoint" => new VRML::NodeType("MotorJoint", [
		axis1Angle => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		axis1Torque => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		axis2Angle => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		axis2Torque => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		axis3Angle => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		axis3Torque => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		body1 => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		body2 => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		enabledAxes => ["SFInt32", 1, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		forceOutput => ["MFString", ["NONE"], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		motor1Axis => ["SFVec3f",[0,0,0],"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		motor2Axis => ["SFVec3f",[0,0,0],"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		motor3Axis => ["SFVec3f",[0,0,0],"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		stop1Bounce => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		stop1ErrorCorrection => ["SFFloat", .8, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		stop2Bounce => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		stop2ErrorCorrection => ["SFFloat", .8, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		stop3Bounce => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		stop3ErrorCorrection => ["SFFloat", .8, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],

		motor1Angle=>["SFFloat",0.0,"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		motor1AngleRate=>["SFFloat",0.0,"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		motor2Angle=>["SFFloat",0.0,"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		motor2AngleRate=>["SFFloat",0.0,"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		motor3Angle=>["SFFloat",0.0,"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		motor3AngleRate=>["SFFloat",0.0,"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		autoCalc => ["SFBool", "FALSE", "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_joint => ["FreeWRLPTR", 0, "initializeOnly", 0],
		_forceout => ["SFInt32", 0, "initializeOnly", 0],
		__old_motor1Axis => ["SFVec3f",[0,0,0],"outputOnly", 0],
		__old_motor2Axis => ["SFVec3f",[0,0,0],"outputOnly", 0],
		__old_motor3Axis => ["SFVec3f",[0,0,0],"outputOnly", 0],
		__old_body1 => ["SFNode", "NULL", "inputOutput", 0],
		__old_body2 => ["SFNode", "NULL", "inputOutput", 0],
		__old_axis1Angle => ["SFFloat", 0, "inputOutput", 0],
		__old_axis2Angle => ["SFFloat", 0, "inputOutput", 0],
		__old_axis3Angle => ["SFFloat", 0, "inputOutput", 0],
	], "X3DRigidJointNode"),

	"RigidBody" => new VRML::NodeType("RigidBody", [
		angularDampingFactor => ["SFFloat", 0.001, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		angularVelocity => ["SFVec3f", [0,0,0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		autoDamp => ["SFBool", "FALSE", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		autoDisable => ["SFBool", "FALSE", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		centerOfMass => ["SFVec3f", [0,0,0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		disableAngularSpeed => ["SFFloat", 0.0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		disableLinearSpeed => ["SFFloat", 0.0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		disableTime => ["SFFloat", 0.0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		enabled => ["SFBool", "TRUE", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		finiteRotationAxis => ["SFVec3f", [0,0,0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		fixed => ["SFBool", "FALSE", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		forces => ["MFVec3f",[],"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		geometry => ["MFNode",[],"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		inertia => ["SFMatrix3f",[1,0,0,0,1,0,0,0,1],"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		linearDampingFactor => ["SFFloat", 0.001, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		linearVelocity => ["SFVec3f", [0,0,0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		mass => ["SFFloat", 1, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		massDensityModel => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		orientation => ["SFRotation", [0, 0, 1, 0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		position => ["SFVec3f", [0, 0, 0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		torques => ["MFVec3f",[],"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		useFiniteRotation => ["SFBool", "FALSE", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		useGlobalGravity => ["SFBool", "TRUE", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		_body => ["FreeWRLPTR", 0, "initializeOnly", 0],
		__old_angularVelocity => ["SFVec3f", [0,0,0], "inputOutput", 0],
		__old_centerOfMass => ["SFVec3f", [0,0,0], "inputOutput", 0],
		__old_finiteRotationAxis => ["SFVec3f", [0,0,0], "inputOutput", 0],
		__old_linearVelocity => ["SFVec3f", [0,0,0], "inputOutput", 0],
		__old_orientation => ["SFRotation", [0, 0, 1, 0], "inputOutput", 0],
		__old_position => ["SFVec3f", [0, 0, 0], "inputOutput", 0],
		_geomIdentityTransform => ["FreeWRLPTR", 0, "initializeOnly", 0],
	], "X3DSFNode"),

	"RigidBodyCollection" => new VRML::NodeType("RigidBodyCollection", [
		set_contacts =>["MFNode",[],"inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		autoDisable => ["SFBool", "FALSE", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		bodies => ["MFNode",[],"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		constantForceMix => ["SFFloat", .0001, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		contactSurfaceThickness => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		disableAngularSpeed => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		disableLinearSpeed => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		disableTime => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		enabled => ["SFBool", "TRUE", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		errorCorrection => ["SFFloat", 0.8, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		gravity => ["SFVec3f", [0, -9.8, 0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		iterations => ["SFInt32",10,"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		joints => ["MFNode",[],"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		maxCorrectionSpeed => ["SFFloat", -1.8, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		preferAccuracy => ["SFBool", "FALSE", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		collider => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
	...
	"SingleAxisHingeJoint" => new VRML::NodeType("SingleAxisHingeJoint", [
		anchorPoint => ["SFVec3f", [0,0,0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		axis => ["SFVec3f", [0,0,1], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		body1 => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		body2 => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		forceOutput => ["MFString", ["NONE"], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		maxAngle => ["SFFloat", "PIF+", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		minAngle => ["SFFloat", "-PIF+", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		stopBounce => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		stopErrorCorrection => ["SFFloat", .8, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		angle=>["SFFloat",0.0,"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		angleRate=>["SFFloat",0.0,"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		body1AnchorPoint => ["SFVec3f",[0,0,0],"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		body2AnchorPoint => ["SFVec3f",[0,0,0],"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_joint => ["FreeWRLPTR", 0, "initializeOnly", 0],
		_forceout => ["SFInt32", 0, "initializeOnly", 0],
		__old_anchorPoint => ["SFVec3f", [0,0,0], "inputOutput", 0],
		__old_axis => ["SFVec3f", [0,0,0], "inputOutput", 0],
		__old_body1 => ["SFNode", "NULL", "inputOutput", 0],
		__old_body2 => ["SFNode", "NULL", "inputOutput", 0],
	], "X3DRigidJointNode"),

	"SliderJoint" => new VRML::NodeType("SliderJoint", [
		axis => ["SFVec3f", [0,0,0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		body1 => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		body2 => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		forceOutput => ["MFString", ["NONE"], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		maxSeparation => ["SFFloat", 1.0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		minSeparation => ["SFFloat", 0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		sliderForce => ["SFFloat", 0, "inputOutput", "( SPEC_X3D33)"],
		stopBounce => ["SFFloat",  0, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		stopErrorCorrection => ["SFFloat",  1, "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		separation => ["SFFloat",0.0,"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		separationRate=>["SFFloat",0.0,"outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_joint => ["FreeWRLPTR", 0, "initializeOnly", 0],
		_forceout => ["SFInt32", 0, "initializeOnly", 0],
		__old_axis => ["SFVec3f", [0,0,0], "inputOutput", 0],
		__old_body1 => ["SFNode", "NULL", "inputOutput", 0],
...
# DJTRACK_PICKSENSORS
	"PickableGroup" => new VRML::NodeType("PickableGroup", [
		...
		children => ["MFNode", [], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		objectType => ["MFString", ["ALL","NONE","TERRAIN"],"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		pickable => ["SFBool", "TRUE","inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		bboxCenter => ["SFVec3f", [0, 0, 0], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		bboxSize => ["SFVec3f", [-1, -1, -1], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
	...
	"PointPickSensor" => new VRML::NodeType("PointPickSensor", [
		enabled => ["SFBool", "FALSE","inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		objectType => ["MFString", ["ALL","NONE","TERRAIN"],"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		pickingGeometry => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		pickTarget => ["MFNode", [], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		isActive  => ["SFBool", "FALSE","outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		pickedGeometry => ["MFNode", [], "outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		...
		matchCriterion => ["SFString","MATCH_ANY","inputOutput", "(SPEC_X3D33)"],
		# These fields are used for the info.
		__oldEnabled => ["SFBool", "TRUE", "inputOutput", 0],
		pickedPoint => ["MFVec3f", [], "outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		
		#DJTRACK
		_oldisActive  => ["SFBool", "FALSE","outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_oldpickTarget => ["MFNode", [], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		_oldpickedGeometry => ["MFNode", [], "outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_oldpickedPoint => ["MFVec3f", [], "outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_bboxCenter => ["SFVec3f", [0, 0, 0], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_bboxSize => ["SFVec3f", [-1, -1, -1], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		set_intersectionType => ["SFString", undef, "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		set_sortOrder => ["SFString", undef, "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
	],"X3DSensorNode"),
	...
	"LinePickSensor" => new VRML::NodeType("LinePickSensor", [
		...
		__oldEnabled => ["SFBool", "TRUE", "inputOutput", 0],
		pickedPoint => ["MFVec3f", [], "outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		pickedNormal => ["MFVec3f", [], "outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		pickedTextureCoordinate => ["MFVec3f", [], "outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
	],"X3DSensorNode"),
	...
	"ColorChaser" => new VRML::NodeType("ColorChaser", [
		...
		isActive  => ["SFBool", "FALSE","outputOnly", "( SPEC_X3D32 | SPEC_X3D33)"],
		duration  => ["SFTime", 1,"initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_bufferendtime  => ["SFTime", 0,"initializeOnly", 0],
		_steptime  => ["SFTime", 0,"initializeOnly", 0],
		value_changed => ["SFColor", [0,0,0], "outputOnly", "( SPEC_X3D32 | SPEC_X3D33)"],
		initialDestination => ["SFColor", [.8,.8,.8], "initializeOnly", "( SPEC_X3D32 | SPEC_X3D33)"],
		initialValue => ["SFColor", [.8,.8,.8], "initializeOnly", "( SPEC_X3D32 | SPEC_X3D33)"],
		set_destination => ["SFColor", [0,0,0], "inputOnly", "( SPEC_X3D32 | SPEC_X3D33)"],
		set_value => ["SFColor", [0,0,0], "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
	...
	"ColorDamper" => new VRML::NodeType("ColorDamper", [
		...
		_p => ["FreeWRLPTR", "NULL", "initializeOnly", 0],
		_t => ["FreeWRLPTR", "NULL", "initializeOnly", 0],
		tau  => ["SFTime", .3,"inputOutput", "( SPEC_X3D32 | SPEC_X3D33)"],
		tolerance => ["SFFloat", -1,"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		isActive  => ["SFBool", "FALSE","outputOnly", "( SPEC_X3D32 | SPEC_X3D33)"],
		order => ["SFInt32", 3, "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_tau  => ["SFTime", .3,"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
	...
	"CoordinateChaser" => new VRML::NodeType("CoordinateChaser", [
		...
		_bufferendtime  => ["SFTime", 0,"initializeOnly", 0],
		_steptime  => ["SFTime", 0,"initializeOnly", 0],
		value_changed => ["MFVec3f", [], "outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		initialDestination => ["MFVec3f", [[0,0,0]], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		initialValue => ["MFVec3f", [[0,0,0]], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		set_destination => ["MFVec3f", [], "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		set_value => ["MFVec3f", [], "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_buffer => ["FreeWRLPTR", "NULL", "initializeOnly", 0],
	...
	"OrientationChaser" => new VRML::NodeType("OrientationChaser", [
		...
		_bufferendtime  => ["SFTime", 0,"initializeOnly", 0],
		_steptime  => ["SFTime", 0,"initializeOnly", 0],
		value_changed => ["SFRotation", [0,1,0,0], "outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		initialDestination => ["SFRotation", [0,1,0,0], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		initialValue => ["SFRotation", [0,1,0,0], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		set_destination => ["SFRotation", [0,1,0,0], "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		set_value => ["SFRotation", [0,1,0,0], "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_buffer => ["FreeWRLPTR", "NULL", "initializeOnly", 0],
	...
	"PositionChaser" => new VRML::NodeType("PositionChaser", [
		...
		_bufferendtime  => ["SFTime", 0,"initializeOnly", 0],
		_steptime  => ["SFTime", 0,"initializeOnly", 0],
		value_changed => ["SFVec3f", [0,0,0], "outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		initialDestination => ["SFVec3f", [0,0,0], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		initialValue => ["SFVec3f", [0,0,0], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		set_destination => ["SFVec3f", [0,0,0], "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		set_value => ["SFVec3f", [0,0,0], "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_buffer => ["FreeWRLPTR", "NULL", "initializeOnly", 0],
	...
	"PositionChaser2D" => new VRML::NodeType("PositionChaser2D", [
		...
		_bufferendtime  => ["SFTime", 0,"initializeOnly", 0],
		_steptime  => ["SFTime", 0,"initializeOnly", 0],
		value_changed => ["SFVec2f", [0,0], "outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		initialDestination => ["SFVec2f", [0,0], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		initialValue => ["SFVec2f", [0,0], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		set_destination => ["SFVec2f", [0,0], "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		set_value => ["SFVec2f", [0,0], "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_buffer => ["FreeWRLPTR", "NULL", "initializeOnly", 0],
	...
	"ScalarChaser" => new VRML::NodeType("ScalarChaser", [
		...
		_bufferendtime  => ["SFTime", 0,"initializeOnly", 0],
		_steptime  => ["SFTime", 0,"initializeOnly", 0],
		value_changed => ["SFFloat", 0, "outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		initialDestination => ["SFFloat", 0, "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		initialValue => ["SFFloat", 0, "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		set_destination => ["SFFloat", 0, "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		set_value => ["SFFloat", 0, "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_buffer => ["FreeWRLPTR", "NULL", "initializeOnly", 0],
	...
	"TexCoordChaser2D" => new VRML::NodeType("TexCoordChaser2D", [
		...
		_bufferendtime  => ["SFTime", 0,"initializeOnly", 0],
		_steptime  => ["SFTime", 0,"initializeOnly", 0],
		value_changed => ["MFVec2f", [], "outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		initialDestination => ["MFVec2f", [[0,0]], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		initialValue => ["MFVec2f", [[0,0]], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		set_destination => ["MFVec2f", [], "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		set_value => ["MFVec2f", [], "inputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_buffer => ["FreeWRLPTR", "NULL", "initializeOnly", 0],
	...
	"BoundedPhysicsModel" => new VRML::NodeType("BoundedPhysicsModel", [
		enabled  => ["SFBool", "TRUE","inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		geometry => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
	],"X3DParticlePhysicsModelNode"),
	
	# 40.4.2 ConeEmitter
	"ConeEmitter" => new VRML::NodeType("ConeEmitter", [
		angle  => ["SFFloat", "PIF*.25","inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		direction  => ["SFVec3f", [0,1,0],"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		position  => ["SFVec3f", [0,0,0],"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		speed  => ["SFFloat", 0,"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		variation  => ["SFFloat", .25,"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		mass  => ["SFFloat", 0,"initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		surfaceArea  => ["SFFloat", 0,"initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
	...
	"ForcePhysicsModel" => new VRML::NodeType("ForcePhysicsModel", [
		enabled  => ["SFBool", "TRUE","inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		force => ["SFVec3f", [0,-9.8,0], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
	],"X3DParticlePhysicsModelNode"),
	...
	"ParticleSystem" => new VRML::NodeType ("ParticleSystem", [
		...
		appearance => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		geometry => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
                metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		bboxCenter => ["SFVec3f", [0, 0, 0], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		bboxSize => ["SFVec3f", [-1, -1, -1], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		...
		createParticles  => ["SFBool", "TRUE","inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		enabled  => ["SFBool", "TRUE","inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		lifetimeVariation  => ["SFFloat", .25,"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		maxParticles  => ["SFInt32", 200,"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		particleLifetime  => ["SFFloat", 5,"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		particleSize => ["SFVec2f", [.02,.02], "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		isActive  => ["SFBool", "TRUE","outputOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		colorRamp => ["SFNode", "NULL", "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		colorKey => ["MFFloat", [], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		emitter => ["SFNode", "NULL", "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		geometryType => ["SFString", "QUAD", "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		physics => ["MFNode", [], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		texCoordRamp => ["SFNode", "NULL", "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		texCoordKey => ["MFFloat", [], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
	...
	"PolylineEmitter" => new VRML::NodeType("PolylineEmitter", [
		set_coordIndex => ["MFInt32", [], "inputOnly", "(SPEC_X3D33)"],
		set_coordinate => ["SFInt32", 0, "inputOnly", "(SPEC_X3D32)"],
		coord => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		direction  => ["SFVec3f", [0,1,0],"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		speed  => ["SFFloat", 0,"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		variation  => ["SFFloat", .25,"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		coordIndex => ["MFInt32", [-1], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		mass  => ["SFFloat", 0,"initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		surfaceArea  => ["SFFloat", 0,"initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
	...
	"SurfaceEmitter" => new VRML::NodeType("SurfaceEmitter", [
		...
		coordIndex => ["MFInt32", [-1], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		mass  => ["SFFloat", 0,"initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		surface => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		surfaceArea  => ["SFFloat", 0,"initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		geometry => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
	...
	"VolumeEmitter" => new VRML::NodeType("VolumeEmitter", [
		...
		variation  => ["SFFloat", .25,"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		coordIndex => ["MFInt32", [-1], "initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		internal  => ["SFBool", "TRUE","inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		mass  => ["SFFloat", 0,"initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		surfaceArea  => ["SFFloat", 0,"initializeOnly", "(SPEC_X3D32 | SPEC_X3D33)"],
		_ifs => ["FreeWRLPTR", "NULL", "initializeOnly", 0],
	],"X3DParticleEmitterNode"),
	...
	"WindPhysicsModel" => new VRML::NodeType("WindPhysicsModel", [
		direction  => ["SFVec3f", [0,1,0],"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		enabled  => ["SFBool", "TRUE","inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		gustiness => ["SFFloat", .1,"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		metadata => ["SFNode", "NULL", "inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		speed  => ["SFFloat", .1,"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],
		turbulence  => ["SFFloat", 0,"inputOutput", "(SPEC_X3D32 | SPEC_X3D33)"],

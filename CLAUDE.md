...
- `origin` = https://github.com/DJAscendance/freewrl: this fork on GitHub, where we push. Its `master` mirrors upstream `master`. The first Mac port (`macos-arm64`, PR #1) is based on that `master`, and we keep it unchanged as a reference.
